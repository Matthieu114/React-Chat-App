...
const useStyles = (theme) => ({
  ...
  message: {
    ...
    margin: '0px 10px',
    fontSize: 'small',
    borderRadius: '20px 15px 15px 3px',
  ...
  myMessage: {
    ...
    fontSize: 'small',
    borderRadius: '20px 15px 3px 15px',
...
export default forwardRef(({messages, onScrollDown, channel, setMessages}, ref) => {
  const {oauth} = useContext(Context);
  const styles = useStyles(useTheme());
  let myMessage = true;
